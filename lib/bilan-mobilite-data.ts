  ...
  tests: [
    ...
    },
    {
      ...
      scoring: [
        ...
        { value: 1, label: 'Partiel', description: 'Squat partiel ou buste effondré' },
    ...
    },
    {
      ...
      scoring: [
        { value: 0, label: 'Impossible', description: 'Impossible de monter en bridge ou douleur antérieure nette' },
...
const mobiliteActive: TestSection = {
  ...
  tests: [
    ...
    { id: 'act-4', name: "L'aviateur", description: 'Rotation ext. + int. + équilibre', criteria: "5 reps de chaque côté. Évaluer la capacité à maintenir l'équilibre.", scoring: [{ value: 0, label: 'Impossible', description: "Impossible de faire une seule rep" }, { value: 1, label: 'Partiel', description: "Doit reposer son pied pendant l'exercice" }, { value: 2, label: 'Correct', description: "5 reps de chaque côté avec appui contre le mur" }, { value: 3, label: 'Parfait', description: "5 reps de chaque côté sans appui" }] },
    { id: 'act-5', name: 'Contrôle scapulo-huméral', description: 'Élévation bras – Wall slide actif', criteria: "Bras montent au-dessus des oreilles, dos et bassin plaqués au mur.", scoring: [{ value: 0, label: 'Impossible', description: "Douleur ou impossibilité" }, { value: 1, label: 'Partiel', description: "Amplitude réduite ou perte du contact mur" }, { value: 2, label: 'Correct', description: "Mouvement complet avec légère hyperlordose" }, { value: 3, label: 'Parfait', description: "Mouvement complet sans compensation" }] },
    { id: 'act-6', name: 'Contrôle lombo-pelvien', description: 'Step-down contrôlé – 15 reps', criteria: "Genou aligné, bassin stable, descente lente. 15 reps gauche + droite.", scoring: [{ value: 0, label: 'Impossible', description: "Douleur ou impossibilité de faire les 15 reps" }, { value: 1, label: 'Partiel', description: "Valgus marqué ou contrôle insuffisant" }, { value: 2, label: 'Correct', description: "Légère instabilité ou asymétrie" }, { value: 3, label: 'Parfait', description: "15 reps propres G + D" }] },
...
const proprioception: TestSection = {
  ...
  tests: [
    ...
    { id: 'prop-3', name: 'Tandem stance', description: "Pied devant l'autre – Yeux ouverts puis fermés", criteria: "Un pied devant l'autre en ligne. D'abord yeux ouverts, puis yeux fermés. 30 sec = objectif.", scoring: [{ value: 0, label: 'Impossible', description: 'Impossible' }, { value: 1, label: '< 15 s', description: 'Moins de 15 secondes' }, { value: 2, label: '15 – 29 s', description: '15 à 29 secondes' }, { value: 3, label: '30 s', description: '30 s stable sans mouvement parasite' }] },
    { id: 'prop-4', name: 'Tandem walk', description: 'Marche sur une ligne – Nb de pas propres', criteria: "Marcher sur une ligne droite, pied devant pied. Compter le nombre de pas propres consécutifs.", scoring: [{ value: 0, label: '< 3 pas', description: 'Moins de 3 pas' }, { value: 1, label: '3 – 5 pas', description: '3 à 5 pas' }, { value: 2, label: '6 – 9 pas', description: '6 à 9 pas' }, { value: 3, label: '≥ 10 pas', description: '10 pas propres consécutifs ou plus' }] },
    { id: 'prop-5', name: 'Y-Balance simplifié', description: 'Star excursion – 3 directions', criteria: "Debout sur un pied, tendre l'autre jambe dans 3 directions (avant, côté, arrière). Évaluer la symétrie gauche/droite.", scoring: [{ value: 0, label: 'Impossible', description: 'Impossible' }, { value: 1, label: 'Partiel', description: 'Forte asymétrie ou instabilité majeure' }, { value: 2, label: 'Correct', description: 'Symétrie acceptable avec compensations' }, { value: 3, label: 'Parfait', description: 'Symétrie et contrôle dans les 3 directions' }] },
    { id: 'prop-6', name: 'Step-over contrôlé', description: 'Enjamber un obstacle – 10 reps', criteria: "Enjamber un petit obstacle (livre, coussin) 10 reps. Évaluer la stabilité.", scoring: [{ value: 0, label: 'Impossible', description: 'Impossible ou peur marquée' }, { value: 1, label: 'Partiel', description: '< 10 reps ou déséquilibres fréquents' }, { value: 2, label: 'Correct', description: '10 reps avec légère instabilité' }, { value: 3, label: 'Parfait', description: '10 reps fluides, stables' }] },
...
const gainage: TestSection = {
  ...
  tests: [
    ...
    { id: 'gain-5', name: 'Pallof press (élastique)', description: 'Anti-rotation – 10 reps lentes', criteria: "Avec un élastique, bras tendus, extension du nombril vers la tête. 10 reps lentes sans rotation du tronc.", tip: "Si vous n'avez pas d'élastique, faites le mouvement en imaginant une résistance latérale.", scoring: [{ value: 0, label: 'Impossible', description: 'Impossible' }, { value: 1, label: 'Partiel', description: 'Instabilité marquée' }, { value: 2, label: 'Correct', description: 'Légère rotation' }, { value: 3, label: 'Parfait', description: '10 reps lentes sans rotation' }] },
    { id: 'gain-6', name: 'Bird-dog dynamique', description: 'Coordination – 60 reps alternées', criteria: "À quatre pattes, toucher coude et genou opposés puis étendre. 60 reps en alternant.", scoring: [{ value: 0, label: 'Impossible', description: 'Impossible' }, { value: 1, label: 'Partiel', description: "Désorganisation / perte d'alignement" }, { value: 2, label: 'Correct', description: 'Coordination correcte mais lente' }, { value: 3, label: 'Parfait', description: 'Mouvement fluide, contrôle total' }] },
    { id: 'gain-7', name: 'Quadrupédie + déplacement', description: 'Bear crawl lent – 2 mètres', criteria: "À quatre pattes, genoux décollés du sol, avancer par incréments de 10-15 cm. Bassin stable sur 2 mètres.", scoring: [{ value: 0, label: 'Impossible', description: 'Impossible' }, { value: 1, label: 'Partiel', description: 'Désorganisation' }, { value: 2, label: 'Correct', description: 'Instabilité légère' }, { value: 3, label: 'Parfait', description: 'Déplacements contrôlés, bassin stable sur 2 m' }] },
...
const prepaPhysique: TestSection = {
  ...
  maxScore: 30,
  tests: [
    { id: 'prep-1', name: '5× Sit-to-Stand', description: 'Force bas du corps – Chronométré', criteria: "Se lever 5 fois d'une chaise sans utiliser les mains, le plus vite possible. Chronométrer.", scoring: [{ value: 0, label: '> 20 s', description: 'Plus de 20 s ou impossible' }, { value: 1, label: '15 – 20 s', description: '15 à 20 secondes' }, { value: 2, label: '10 – 14 s', description: '10 à 14 secondes' }, { value: 3, label: '< 10 s', description: 'Moins de 10 secondes' }] },
    { id: 'prep-2', name: '30 s Chair Stand', description: 'Endurance bas du corps – Max reps', criteria: "Se lever et s'asseoir le plus de fois possible en 30 secondes, sans les mains.", scoring: [{ value: 0, label: '< 5 reps', description: 'Moins de 5 répétitions' }, { value: 1, label: '5 – 9 reps', description: '5 à 9 répétitions' }, { value: 2, label: '10 – 14 reps', description: '10 à 14 répétitions' }, { value: 3, label: '≥ 15 reps', description: '15 répétitions ou plus' }] },
    { id: 'prep-3', name: 'Demi-squat mural', description: 'Isométrie – Temps max', criteria: "Dos au mur, cuisses à 90°, maintenir la position le plus longtemps possible.", scoring: [{ value: 0, label: '< 20 s', description: 'Moins de 20 secondes' }, { value: 1, label: '20 – 44 s', description: '20 à 44 secondes' }, { value: 2, label: '45 – 89 s', description: '45 à 89 secondes' }, { value: 3, label: '≥ 90 s', description: '90 secondes ou plus' }] },
    { id: 'prep-4', name: 'Timed Up & Go', description: 'Locomotion – Chaise → 3 m → retour', criteria: "Se lever d'une chaise, marcher 3 mètres, faire demi-tour, revenir s'asseoir. Chronométrer.", scoring: [{ value: 0, label: '> 14 s', description: 'Plus de 14 secondes' }, { value: 1, label: '10 – 14 s', description: '10 à 14 secondes' }, { value: 2, label: '8 – 10 s', description: '8 à 10 secondes' }, { value: 3, label: '< 8 s', description: 'Moins de 8 secondes' }] },
    { id: 'prep-5', name: '2 min Step Test', description: 'Cardio – Genoux sur place', criteria: "Lever les genoux sur place pendant 2 minutes. Compter le nombre de montées de genou.", scoring: [{ value: 0, label: '< 50', description: 'Moins de 50 montées' }, { value: 1, label: '50 – 74', description: '50 à 74 montées' }, { value: 2, label: '75 – 99', description: '75 à 99 montées' }, { value: 3, label: '≥ 100', description: '100 montées ou plus' }] },
    { id: 'prep-6', name: 'Push-ups', description: 'Poussée – Max reps propres', criteria: "Pompes au sol (genoux ou pieds au sol). Compter le nombre de répétitions propres.", scoring: [{ value: 0, label: '< 3', description: 'Moins de 3 reps' }, { value: 1, label: '3 – 7', description: '3 à 7 reps' }, { value: 2, label: '8 – 14', description: '8 à 14 reps' }, { value: 3, label: '≥ 15', description: '15 reps propres ou plus' }] },
    { id: 'prep-7', name: 'Tirage élastique', description: 'Tirage – Max reps (debout ou assis)', criteria: "Avec un élastique, tirer vers soi. Comptez les reps propres.", tip: "Si vous n'avez pas d'élastique, vous pouvez sauter ce test.", scoring: [{ value: 0, label: 'Impossible', description: 'Impossible' }, { value: 1, label: '< 8', description: 'Moins de 8 reps' }, { value: 2, label: '8 – 14', description: '8 à 14 reps' }, { value: 3, label: '≥ 15', description: '15 reps propres ou plus' }] },
    { id: 'prep-8', name: 'Développé épaules', description: 'Épaules – Élastique si indolore', criteria: "Développé épaules avec un élastique. Comptez les reps indolores.", scoring: [{ value: 0, label: 'Impossible', description: 'Impossible' }, { value: 1, label: '< 8', description: 'Moins de 8 reps' }, { value: 2, label: '8 – 14', description: '8 à 14 reps' }, { value: 3, label: 'Parfait', description: '15 reps propres ou plus' }] },
    { id: 'prep-9', name: 'Farmer hold', description: "Préhension – Pack d'eau 6-9 kg", criteria: "Tenir un pack d'eau (6-9 kg) dans chaque main, bras le long du corps, posture droite. Chronométrer.", scoring: [{ value: 0, label: '< 30 s', description: 'Moins de 30 secondes' }, { value: 1, label: '30 – 59 s', description: '30 à 59 secondes' }, { value: 2, label: '60 – 119 s', description: '60 à 119 secondes' }, { value: 3, label: '≥ 120 s', description: '120 secondes ou plus, posture parfaite' }] },
