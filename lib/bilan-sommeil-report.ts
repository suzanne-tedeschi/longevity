...
const qualiteImpactReport: SectionReport = {
  ...
  questionInsights: [
    ...
    },
    {
      ...
      insight:
        "Les benzodiazépines et le zolpidem (Stilnox) induisent la sédation en activant des récepteurs inhibiteurs du cerveau (GABA-A) : mais ce n'est pas du vrai sommeil. L'activité cérébrale mesurée à l'EEG (électroencéphalogramme) est différente : moins d'ondes lentes profondes, moins de sommeil paradoxal. La mémoire ne se consolide pas de la même façon. Le zolpidem peut aussi provoquer des comportements automatiques nocturnes (somnambulisme, alimentation, conduite) dans environ 3 % des cas. Quant au CBD, il agit sur les systèmes d'éveil du cerveau d'une façon qui peut désynchroniser le sommeil paradoxal : les preuves cliniques sur le sommeil restent insuffisantes.",
      recommendation:
...
export const globalKeyInsights: GlobalInsight[] = [
  {
    ...
    description:
      "**Dormir moins de 7h/nuit de façon chronique augmente la mortalité toutes causes de 12 %**, et multiplie les risques de diabète de type 2, de maladies cardiovasculaires et de certains cancers.\n\n**Sur le système immunitaire :** une seule nuit courte réduit de 70 % l'activité des cellules immunitaires chargées d'éliminer les cellules infectées ou cancéreuses, et active des centaines de gènes pro-inflammatoires. Le corps se retrouve en état d'inflammation chronique de bas grade.\n\n**Sur le métabolisme :** la sensibilité à l'insuline chute après une nuit insuffisante : le corps gère moins bien le sucre sanguin, comme dans un état pré-diabétique. La testostérone baisse significativement. L'hormone de croissance, libérée presque exclusivement en sommeil profond, orchestre la réparation des tissus : muscles, peau, os : elle n'a pas de deuxième fenêtre dans la journée.\n\n**Sur le cerveau :** le système glymphatique : le réseau de nettoyage cérébral actif pendant le sommeil profond : élimine les protéines toxiques liées à Alzheimer 10 fois plus efficacement que pendant l'éveil. Le sommeil n'est pas un luxe récupérable le week-end : c'est la maintenance quotidienne obligatoire de l'ensemble du corps.",
    reference: 'Médecine du sommeil et chronobiologie',
  },
  {
    title: 'L\'amygdale sans sommeil : 60 % plus réactive',
    description:
      "**Une seule nuit insuffisante rend l'amygdale : le centre des émotions : 60 % plus réactive aux stimuli négatifs.** En parallèle, sa connexion avec le cortex préfrontal (le frein rationnel) s'affaiblit. Les mêmes situations déclenchent plus d'irritabilité, d'anxiété et de réactions impulsives : ce n'est pas un manque de caractère, c'est neurologique.\n\n**Sur la mémoire et l'apprentissage :** le sommeil profond consolide ce qu'on a appris dans la journée en le transférant dans la mémoire à long terme. Mal dormir, c'est partiellement effacer ce qu'on a retenu. La créativité chute aussi : le cerveau fait moins de connexions inattendues entre les idées.\n\n**Sur l'appétit :** les hormones de la faim se dérèglent : la ghréline (qui donne faim) augmente, la leptine (qui signale la satiété) baisse. D'où les fringales et les envies de sucre après une mauvaise nuit : ce n'est pas un manque de volonté, c'est hormonal.\n\n**Après 10 nuits à 6h**, les performances cognitives atteignent le niveau d'une privation totale de 24h : mais le déficit est systématiquement sous-estimé, car on s'habitue à fonctionner en mode dégradé sans s'en rendre compte.",
    reference: 'Neurosciences cognitives et médecine du sommeil',
  },
  {
    title: 'Le REM : une thérapie émotionnelle gratuite chaque nuit',
    description:
      "Pendant le sommeil paradoxal (REM), le cerveau fait quelque chose de remarquable : **il rejoue les souvenirs émotionnellement chargés de la journée, mais dans un environnement sans noradrénaline** : le neurotransmetteur du stress. C'est la seule période où le cerveau traite des émotions intenses sans en ressentir la charge. À chaque cycle REM, la composante émotionnelle du souvenir s'émousse un peu, jusqu'à ce que le fait reste en mémoire mais sans le poids émotionnel initial. C'est pour cela que les problèmes paraissent toujours moins lourds au matin qu'au soir.\n\n**Sur les traumatismes :** ce mécanisme est au cœur du traitement des chocs émotionnels. Son dysfonctionnement est l'une des causes du stress post-traumatique : les souvenirs restent chargés parce que le REM n'a pas pu les \"désamorcer\".\n\n**Sur la créativité et la motivation :** le REM réinitialise les circuits de la dopamine (motivation, plaisir) et crée des connexions inattendues entre des souvenirs éloignés. Beaucoup de grandes idées, de solutions créatives et d'intuitions émergent au réveil : ce n'est pas du hasard.\n\n**Ce qui coupe le REM en premier :** l'alcool, certains somnifères, et les réveils précoces. Cette phase se concentre en fin de nuit : les deux dernières heures de sommeil en sont les plus riches.",
...
export const sommeilGlossary: { term: string; definition: string }[] = [
  ...
  { term: 'EEG (électroencéphalographie)', definition: "Technique d'enregistrement de l'activité électrique cérébrale via des électrodes posées sur le crâne. Outil de référence pour identifier les stades du sommeil (NREM N1-N3, REM) et détecter les micro-éveils." },
  { term: 'PPC (pression positive continue)', definition: "Traitement de référence des apnées du sommeil : un appareil envoie un flux d'air continu via un masque nasal pour maintenir les voies respiratoires ouvertes toute la nuit. Élimine les désaturations et restaure le sommeil profond dès la première nuit." },
...
export function generateFullReport(
  ...
  weaknesses.sort((a, b) => {
    // "Signaux spécifiques à explorer avec un médecin" toujours en dernier
