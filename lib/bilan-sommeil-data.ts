...
const troublesSommeil: TestSection = {
  ...
  tests: [
    ...
    },
    {
      ...
      criteria: 'Au cours du mois dernier, à quelle fréquence avez-vous eu de mauvais rêves ou des cauchemars ?',
      scoring: psqiFrequencyScoring,
    },
    {
      id: 'som-9',
...
const qualiteImpact: TestSection = {
  ...
  tests: [
    ...
    },
    {
      ...
      criteria: 'Au cours du mois dernier, à quel degré cela a-t-il représenté un problème d\'avoir assez d\'enthousiasme pour faire ce que vous aviez à faire ?',
      scoring: [
...
const hygieneSommeil: TestSection = {
  ...
  tests: [
    ...
    },
    {
      ...
      criteria: 'Je reste au lit plus de 30 minutes sans dormir.',
      scoring: shiFrequencyScoring,
    ...
    },
    {
      ...
      criteria: 'Je bois des boissons contenant de la caféine dans les 4 à 9 heures précédant le coucher.',
      scoring: shiFrequencyScoring,
    ...
    },
    {
      ...
      criteria: 'Je prends des siestes de plus de 30 minutes de durée.',
      scoring: shiFrequencyScoring,
    ...
    },
    {
      ...
      criteria: 'Je consomme des repas lourds, épicés ou sucrés dans les 2 heures précédant le coucher.',
      scoring: shiFrequencyScoring,
    },
    {
      id: 'hyg-9',
