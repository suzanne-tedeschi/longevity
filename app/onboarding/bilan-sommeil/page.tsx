...
function WelcomeScreen({ onStart }: { onStart: () => void }) {
  return (
    <div className="animate-fade-in flex flex-col items-center justify-center min-h-[80vh] text-center px-4">
      ...
      <h1 className="text-3xl md:text-4xl font-bold text-navy-dark mb-3 tracking-tight">Bilan Sommeil</h1>
      <h2 className="text-sm font-medium tracking-widest uppercase text-gold-dark mb-8">Qualité & hygiène du sommeil</h2>
  ...
  return (
    <div className="animate-fade-in max-w-2xl mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-sm text-navy/50">Bilan sommeil — qualité & hygiène</p>
      </div>
