      ...
      <div className={`relative bg-gradient-to-br ${hero.heroGradient} border border-[#1a1a1a]/[0.07] rounded-3xl px-6 py-8 mb-8 overflow-hidden`}>
        ...
        <div className="relative flex items-center gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-[#2D6A4F] font-medium leading-relaxed">Lis nos recommandations et essaie d&apos;en intégrer autant que tu peux. Evo revient vers toi sur Whatsapp pour suivre tes progrès et répondre à toutes tes questions !</p>
          </div>
        </div>
        {/* Save status */}
