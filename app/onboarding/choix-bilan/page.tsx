  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <nav className="w-full px-6 py-5 flex items-center justify-between">
        ...
        <button
          onClick={() => router.back()}
          className="text-sm text-navy/50 hover:text-navy transition-colors duration-300 flex items-center gap-1.5"
        >
      ...
      <div className="max-w-3xl mx-auto px-6 pb-20">
        ...
        <div className={`text-center mb-12 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h1 className="text-3xl md:text-4xl font-bold text-navy-dark mb-4 leading-tight">
            Choisissez votre <span className="gradient-text">bilan</span>
          </h1>
          <p className="text-lg text-navy/70 max-w-lg mx-auto">
            ...
            >
              {bilan.available ? (
                <button
                  ...
                  className="w-full text-left group relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-gold/10 hover:border-gold/30 hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-500 hover:-translate-y-0.5"
                >
                  <div className="flex items-start gap-5">
                    {/* Icon */}
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-navy-dark/5 to-bordeaux/5 flex items-center justify-center flex-shrink-0 text-navy-dark group-hover:from-navy-dark/10 group-hover:to-bordeaux/10 transition-all duration-500">
                      {bilan.icon}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1.5">
                        <h3 className="text-lg font-semibold text-navy-dark group-hover:text-bordeaux transition-colors duration-300">
                          {bilan.title}
                        </h3>
                        <span className="text-xs font-medium text-navy/40 bg-beige-200 px-2.5 py-0.5 rounded-full">
                          {bilan.duration}
                        </span>
                      </div>
                    ...
                    {/* Arrow */}
                    <div className="flex-shrink-0 mt-3 text-navy/30 group-hover:text-bordeaux transition-all duration-300 group-hover:translate-x-1">
                  ...
                  {/* Hover gold line */}
                  <div className="absolute bottom-0 left-6 right-6 h-0.5 bg-gradient-to-r from-bordeaux to-gold scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left rounded-full" />
                </button>
              ) : (
                <div className="w-full text-left relative bg-white/40 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 opacity-60 cursor-default">
                  <div className="flex items-start gap-5">
                    {/* Icon */}
                    <div className="w-14 h-14 rounded-xl bg-gray-100 flex items-center justify-center flex-shrink-0 text-navy/30">
                      {bilan.icon}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1.5">
                        ...
                        <span className="text-xs font-medium text-white bg-navy/30 px-2.5 py-0.5 rounded-full">
                          Bientôt disponible
                        </span>
                      </div>
