    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto px-6">
        ...
        <div className="bg-white backdrop-blur-sm rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.06)] border border-[#1a1a1a]/[0.08]">
          {/* Tabs */}
          <div className="flex mb-8 bg-[#1a1a1a]/[0.03] rounded-xl p-1">
            <button
              onClick={() => setMode('signup')}
              className={`flex-1 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 ${
                mode === 'signup'
                  ? 'bg-[#1a1a1a]/[0.06] text-[#1a1a1a] shadow-sm'
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              ...
              <span className="text-sm font-medium text-[#1a1a1a]/60">Continuer avec Google</span>
            </button>
